# Web Interface Guidelines (expanded)

Editable expanded guidelines used by the `ui-laws-audit` skill to explain *how* to comply when a concise rule fails.
Upstream: [vercel-labs/web-interface-guidelines README.md](https://github.com/vercel-labs/web-interface-guidelines/blob/main/README.md).

**How to maintain this file**
- Edit freely — this local copy is the audit source of truth for deeper definitions and examples.
- Prefer keeping section headings stable (`## Interactions`, `## Forms`, etc.) so audits can cite them.
- Add project-specific notes under a `## Project overrides` section at the bottom rather than deleting upstream guidance wholesale.
- Optional: sync from upstream with `curl -fsSL https://raw.githubusercontent.com/vercel-labs/web-interface-guidelines/main/README.md` then re-apply this header and any project overrides.
...
_Add Twisted Brackets / blog-specific exceptions or additions below. Audit the skill against these after the upstream sections._
