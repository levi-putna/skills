---
name: component-document-contract
...
description: >-
  ...
  Markdown file that sits next to its source, e.g. `button.tsx` + `button.md`.
  Covers everything a consumer needs to use the component correctly: purpose,
  props/events API, behaviour, accessibility, states, variants, and usage
  examples. Use when asked to "document this component", "write component docs",
  "generate a component spec/contract", "add a README/spec for this element", or
  when a component's `.md` file is missing or out of date with its code.
---
...
```
.skills/component-document-contract/references/component-doc-template.md
```
